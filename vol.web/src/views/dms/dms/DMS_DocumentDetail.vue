 ...
 *Author：jxx
 *Contact：xx
 *业务请在@/extension/dms/dms/DMS_DocumentDetail.jsx或DMS_DocumentDetail.vue文件编写
...
<script setup lang="jsx">
    import extend from "@/extension/dms/dms/DMS_DocumentDetail.jsx";
    import viewOptions from './DMS_DocumentDetail/options.js'
    ...
    const onInit = async ($vm) => {
        ...
        (btn) => ![ '删除', 'Add', 'Edit', 'Delete'].includes(btn.name));//'新建','编辑',

        // gridRef.buttons.unshift({
        //     name: '上传', //名称
    ...
    const modelOpenAfter = (row) => {
        ...
        // gridRef.editFormFields.FileName = FileName;
