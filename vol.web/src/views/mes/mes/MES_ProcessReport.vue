 ...
 *Date：{Date}
 *Contact：xx
 *业务请在@/extension/mes/mes/MES_ProcessReport.jsx或MES_ProcessReport.vue文件编写
...
import extend from "@/extension/mes/mes/MES_ProcessReport.jsx";
import viewOptions from './MES_ProcessReport/options.js'
...
columns.forEach(x => {
    if (x.field == 'CompletedQuantity' || x.field == 'DefectiveQuantity') {
        x.summary = true;
    }
})
