 ...
 *Date：{Date}
 *Contact：xx
 *业务请在@/extension/mes/mes/MES_Supplier.jsx或MES_Supplier.vue文件编写
...
<script setup lang="jsx">
    import extend from "@/extension/mes/mes/MES_Supplier.jsx";
    import viewOptions from './MES_Supplier/options.js'
