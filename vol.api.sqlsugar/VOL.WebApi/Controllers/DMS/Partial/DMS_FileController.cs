...
*如: [ApiActionPermission("DMS_File",Enums.ActionPermissionOptions.Search)]
 */
...
{
    public partial class DMS_FileController
    {
        private readonly IDMS_FileService _service;//访问业务代码
        private readonly IHttpContextAccessor _httpContextAccessor;

        [ActivatorUtilitiesConstructor]
        public DMS_FileController(
            IDMS_FileService service,
